...
public interface TypeSFixed64OrBuilder extends
    // @@protoc_insertion_point(interface_extends:json.TypeSFixed64)
   ...
   * @return The codec.
   */
  io.github.yu31.protoc.pb.pbjson.TypeSFixed64.Codec getCodec();
}
