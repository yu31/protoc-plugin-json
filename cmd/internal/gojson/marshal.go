...
func (ml *Marshal) loadMapKeyTypeInfo(field *protogen.Field, typeCodec *pbjson.TypeCodec,
...
func (ml *Marshal) loadValueTypeInfo(field *protogen.Field, typeCodec *pbjson.TypeCodec,
