...
// MarshalJSON implements interface json.Marshaler for proto message MessageMap1 in file tests/proto/cases/base/type_map.proto
...
// UnmarshalJSON implements json.Unmarshaler for proto message MessageMap1 in file tests/proto/cases/base/type_map.proto
func (x *MessageMap1) UnmarshalJSON(b []byte) error {
	if x == nil {
		return errors.New("json: Unmarshal: xgo/tests/pb/pbbase.(*MessageMap1) is nil")
	}
	var (
		err    error
		isNULL bool
...
// MarshalJSON implements interface json.Marshaler for proto message Embed1 in file tests/proto/cases/base/type_map.proto
...
// UnmarshalJSON implements json.Unmarshaler for proto message Embed1 in file tests/proto/cases/base/type_map.proto
func (x *MessageMap1_Embed1) UnmarshalJSON(b []byte) error {
	if x == nil {
		return errors.New("json: Unmarshal: xgo/tests/pb/pbbase.(*MessageMap1_Embed1) is nil")
	}
	var (
		err    error
		isNULL bool
...
// MarshalJSON implements interface json.Marshaler for proto message Embed2 in file tests/proto/cases/base/type_map.proto
...
// UnmarshalJSON implements json.Unmarshaler for proto message Embed2 in file tests/proto/cases/base/type_map.proto
func (x *MessageMap1_Embed1_Embed2) UnmarshalJSON(b []byte) error {
	if x == nil {
		return errors.New("json: Unmarshal: xgo/tests/pb/pbbase.(*MessageMap1_Embed1_Embed2) is nil")
	}
	var (
		err    error
		isNULL bool
...
// MarshalJSON implements interface json.Marshaler for proto message TypeMap1 in file tests/proto/cases/base/type_map.proto
...
// UnmarshalJSON implements json.Unmarshaler for proto message TypeMap1 in file tests/proto/cases/base/type_map.proto
func (x *TypeMap1) UnmarshalJSON(b []byte) error {
	if x == nil {
		return errors.New("json: Unmarshal: xgo/tests/pb/pbbase.(*TypeMap1) is nil")
	}
	var (
		err    error
		isNULL bool
...
// MarshalJSON implements interface json.Marshaler for proto message TypeMap2 in file tests/proto/cases/base/type_map.proto
...
// UnmarshalJSON implements json.Unmarshaler for proto message TypeMap2 in file tests/proto/cases/base/type_map.proto
func (x *TypeMap2) UnmarshalJSON(b []byte) error {
	if x == nil {
		return errors.New("json: Unmarshal: xgo/tests/pb/pbbase.(*TypeMap2) is nil")
	}
	var (
		err    error
		isNULL bool
...
// MarshalJSON implements interface json.Marshaler for proto message TypeMap3 in file tests/proto/cases/base/type_map.proto
...
// UnmarshalJSON implements json.Unmarshaler for proto message TypeMap3 in file tests/proto/cases/base/type_map.proto
