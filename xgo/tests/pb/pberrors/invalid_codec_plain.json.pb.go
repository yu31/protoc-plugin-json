...
func (x *InvalidCodecPlain) MarshalJSON() ([]byte, error) {
	...
	jsonencoder.AppendValI32(enc, "f_int32_numeric", x.FInt32Numeric, false, false)
	jsonencoder.AppendValI32(enc, "f_int32_string", x.FInt32String, false, true)
	jsonencoder.AppendValI64(enc, "f_int64_numeric", x.FInt64Numeric, false, false)
	jsonencoder.AppendValI64(enc, "f_int64_string", x.FInt64String, false, true)
	jsonencoder.AppendValU32(enc, "f_uint32_numeric", x.FUint32Numeric, false, false)
	jsonencoder.AppendValU32(enc, "f_uint32_string", x.FUint32String, false, true)
	jsonencoder.AppendValU64(enc, "f_uint64_numeric", x.FUint64Numeric, false, false)
	jsonencoder.AppendValU64(enc, "f_uint64_string", x.FUint64String, false, true)
	jsonencoder.AppendValI32(enc, "f_sint32_numeric", x.FSint32Numeric, false, false)
	jsonencoder.AppendValI32(enc, "f_sint32_string", x.FSint32String, false, true)
	jsonencoder.AppendValI64(enc, "f_sint64_numeric", x.FSint64Numeric, false, false)
	jsonencoder.AppendValI64(enc, "f_sint64_string", x.FSint64String, false, true)
	jsonencoder.AppendValI32(enc, "f_sfixed32_numeric", x.FSfixed32Numeric, false, false)
	jsonencoder.AppendValI32(enc, "f_sfixed32_string", x.FSfixed32String, false, true)
	jsonencoder.AppendValI64(enc, "f_sfixed64_numeric", x.FSfixed64Numeric, false, false)
	jsonencoder.AppendValI64(enc, "f_sfixed64_string", x.FSfixed64String, false, true)
	jsonencoder.AppendValU32(enc, "f_fixed32_numeric", x.FFixed32Numeric, false, false)
	jsonencoder.AppendValU32(enc, "f_fixed32_string", x.FFixed32String, false, true)
	jsonencoder.AppendValU64(enc, "f_fixed64_numeric", x.FFixed64Numeric, false, false)
	jsonencoder.AppendValU64(enc, "f_fixed64_string", x.FFixed64String, false, true)
	jsonencoder.AppendValF32(enc, "f_float_numeric", x.FFloatNumeric, false, false)
	jsonencoder.AppendValF32(enc, "f_float_string", x.FFloatString, false, true)
	jsonencoder.AppendValF64(enc, "f_double_numeric", x.FDoubleNumeric, false, false)
	jsonencoder.AppendValF64(enc, "f_double_string", x.FDoubleString, false, true)
	jsonencoder.AppendValBool(enc, "f_bool_bool", x.FBoolBool, false, false)
	jsonencoder.AppendValBool(enc, "f_bool_string", x.FBoolString, false, true)
	jsonencoder.AppendValStr(enc, "f_string_none", x.FStringNone, false)
	if err := jsonencoder.AppendValBytes(enc, "f_bytes_none", x.FBytesNone, false); err != nil {
		return nil, err
	}
	jsonencoder.AppendValEnumNum(enc, "f_enum_numeric", x.FEnumNumeric, false, false)
	jsonencoder.AppendValEnumNum(enc, "f_enum_numeric_string", x.FEnumNumericString, false, true)
	jsonencoder.AppendValEnumStr(enc, "f_enum_string", x.FEnumString, false)
...
func (x *InvalidCodecPlain) UnmarshalJSON(b []byte) error {
	if x == nil {
		return errors.New("json: Unmarshal: xgo/tests/pb/pberrors.(*InvalidCodecPlain) is nil")
	}
	var (
		err    error
		isNULL bool
...
LOOP_SCAN:
	for { // Loop to read the JSON objects
		...
		case "f_int32_numeric":
			if x.FInt32Numeric, err = jsondecoder.ReadValI32(dec, false); err != nil {
				return err
			}
		case "f_int32_string":
			if x.FInt32String, err = jsondecoder.ReadValI32(dec, true); err != nil {
				return err
			}
		case "f_int64_numeric":
			if x.FInt64Numeric, err = jsondecoder.ReadValI64(dec, false); err != nil {
				return err
			}
		case "f_int64_string":
			if x.FInt64String, err = jsondecoder.ReadValI64(dec, true); err != nil {
				return err
			}
		case "f_uint32_numeric":
			if x.FUint32Numeric, err = jsondecoder.ReadValU32(dec, false); err != nil {
				return err
			}
		case "f_uint32_string":
			if x.FUint32String, err = jsondecoder.ReadValU32(dec, true); err != nil {
				return err
			}
		case "f_uint64_numeric":
			if x.FUint64Numeric, err = jsondecoder.ReadValU64(dec, false); err != nil {
				return err
			}
		case "f_uint64_string":
			if x.FUint64String, err = jsondecoder.ReadValU64(dec, true); err != nil {
				return err
			}
		case "f_sint32_numeric":
			if x.FSint32Numeric, err = jsondecoder.ReadValI32(dec, false); err != nil {
				return err
			}
		case "f_sint32_string":
			if x.FSint32String, err = jsondecoder.ReadValI32(dec, true); err != nil {
				return err
			}
		case "f_sint64_numeric":
			if x.FSint64Numeric, err = jsondecoder.ReadValI64(dec, false); err != nil {
				return err
			}
		case "f_sint64_string":
			if x.FSint64String, err = jsondecoder.ReadValI64(dec, true); err != nil {
				return err
			}
		case "f_sfixed32_numeric":
			if x.FSfixed32Numeric, err = jsondecoder.ReadValI32(dec, false); err != nil {
				return err
			}
		case "f_sfixed32_string":
			if x.FSfixed32String, err = jsondecoder.ReadValI32(dec, true); err != nil {
				return err
			}
		case "f_sfixed64_numeric":
			if x.FSfixed64Numeric, err = jsondecoder.ReadValI64(dec, false); err != nil {
				return err
			}
		case "f_sfixed64_string":
			if x.FSfixed64String, err = jsondecoder.ReadValI64(dec, true); err != nil {
				return err
			}
		case "f_fixed32_numeric":
			if x.FFixed32Numeric, err = jsondecoder.ReadValU32(dec, false); err != nil {
				return err
			}
		case "f_fixed32_string":
			if x.FFixed32String, err = jsondecoder.ReadValU32(dec, true); err != nil {
				return err
			}
		case "f_fixed64_numeric":
			if x.FFixed64Numeric, err = jsondecoder.ReadValU64(dec, false); err != nil {
				return err
			}
		case "f_fixed64_string":
			if x.FFixed64String, err = jsondecoder.ReadValU64(dec, true); err != nil {
				return err
			}
		case "f_float_numeric":
			if x.FFloatNumeric, err = jsondecoder.ReadValF32(dec, false); err != nil {
				return err
			}
		case "f_float_string":
			if x.FFloatString, err = jsondecoder.ReadValF32(dec, true); err != nil {
				return err
			}
		case "f_double_numeric":
			if x.FDoubleNumeric, err = jsondecoder.ReadValF64(dec, false); err != nil {
				return err
			}
		case "f_double_string":
			if x.FDoubleString, err = jsondecoder.ReadValF64(dec, true); err != nil {
				return err
			}
		case "f_bool_bool":
			if x.FBoolBool, err = jsondecoder.ReadValBool(dec, false); err != nil {
				return err
			}
		case "f_bool_string":
			if x.FBoolString, err = jsondecoder.ReadValBool(dec, true); err != nil {
				return err
			}
		case "f_string_none":
			if x.FStringNone, err = jsondecoder.ReadValStr(dec); err != nil {
				return err
			}
		case "f_bytes_none":
			if x.FBytesNone, err = jsondecoder.ReadValBytes(dec); err != nil {
				return err
			}
		case "f_enum_numeric":
			if x.FEnumNumeric, err = jsondecoder.ReadValEnumNum(dec, x.FEnumNumeric, false); err != nil {
				return err
			}
		case "f_enum_numeric_string":
			if x.FEnumNumericString, err = jsondecoder.ReadValEnumNum(dec, x.FEnumNumericString, true); err != nil {
				return err
			}
		case "f_enum_string":
			if x.FEnumString, err = jsondecoder.ReadValEnumStr(dec, x.FEnumString, EnumNum1_value); err != nil {
				return err
			}
		case "f_any_native":
