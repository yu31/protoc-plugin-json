...
type Embed_Enum1 int32

const (
	Embed_Zero  Embed_Enum1 = 0
	Embed_One   Embed_Enum1 = 2
	Embed_Two   Embed_Enum1 = 3
	Embed_Three Embed_Enum1 = 5
	Embed_Four  Embed_Enum1 = 6
	Embed_Five  Embed_Enum1 = 7
	Embed_Six   Embed_Enum1 = 9
	Embed_Seven Embed_Enum1 = 11
	Embed_Eight Embed_Enum1 = 12
	Embed_Nine  Embed_Enum1 = 15
	Embed_Ten   Embed_Enum1 = 17
)

// Enum value maps for Embed_Enum1.
var (
	Embed_Enum1_name = map[int32]string{
		0:  "Zero",
		2:  "One",
		3:  "Two",
		5:  "Three",
	...
	Embed_Enum1_value = map[string]int32{
		"Zero":  0,
		"One":   2,
		"Two":   3,
		"Three": 5,
...
func (x Embed_Enum1) Enum() *Embed_Enum1 {
	p := new(Embed_Enum1)
	*p = x
	return p
}

func (x Embed_Enum1) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (Embed_Enum1) Descriptor() protoreflect.EnumDescriptor {
	return file_tests_proto_module_external_proto_enumTypes[1].Descriptor()
}

func (Embed_Enum1) Type() protoreflect.EnumType {
	return &file_tests_proto_module_external_proto_enumTypes[1]
}

func (x Embed_Enum1) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use Embed_Enum1.Descriptor instead.
func (Embed_Enum1) EnumDescriptor() ([]byte, []int) {
	return file_tests_proto_module_external_proto_rawDescGZIP(), []int{0, 0}
}

type Embed_Message_Enum1 int32

const (
	Embed_Message_Zero  Embed_Message_Enum1 = 0
	Embed_Message_One   Embed_Message_Enum1 = 2
	Embed_Message_Two   Embed_Message_Enum1 = 3
	Embed_Message_Three Embed_Message_Enum1 = 5
	Embed_Message_Four  Embed_Message_Enum1 = 6
	Embed_Message_Five  Embed_Message_Enum1 = 7
	Embed_Message_Six   Embed_Message_Enum1 = 9
	Embed_Message_Seven Embed_Message_Enum1 = 11
	Embed_Message_Eight Embed_Message_Enum1 = 12
	Embed_Message_Nine  Embed_Message_Enum1 = 15
	Embed_Message_Ten   Embed_Message_Enum1 = 17
)

// Enum value maps for Embed_Message_Enum1.
var (
	Embed_Message_Enum1_name = map[int32]string{
		0:  "Zero",
		2:  "One",
		3:  "Two",
		5:  "Three",
	...
	Embed_Message_Enum1_value = map[string]int32{
		"Zero":  0,
		"One":   2,
		"Two":   3,
		"Three": 5,
...
func (x Embed_Message_Enum1) Enum() *Embed_Message_Enum1 {
	p := new(Embed_Message_Enum1)
	*p = x
	return p
}

func (x Embed_Message_Enum1) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (Embed_Message_Enum1) Descriptor() protoreflect.EnumDescriptor {
	return file_tests_proto_module_external_proto_enumTypes[2].Descriptor()
}

func (Embed_Message_Enum1) Type() protoreflect.EnumType {
	return &file_tests_proto_module_external_proto_enumTypes[2]
}

func (x Embed_Message_Enum1) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use Embed_Message_Enum1.Descriptor instead.
func (Embed_Message_Enum1) EnumDescriptor() ([]byte, []int) {
...
var file_tests_proto_module_external_proto_rawDesc = []byte{
	...
	0xfe, 0x01, 0x0a, 0x05, 0x45, 0x6d, 0x62, 0x65, 0x64, 0x1a, 0x7f, 0x0a, 0x07, 0x4d, 0x65, 0x73,
	0x73, 0x61, 0x67, 0x65, 0x22, 0x74, 0x0a, 0x05, 0x45, 0x6e, 0x75, 0x6d, 0x31, 0x12, 0x08, 0x0a,
	...
	0x0f, 0x12, 0x07, 0x0a, 0x03, 0x54, 0x65, 0x6e, 0x10, 0x11, 0x22, 0x74, 0x0a, 0x05, 0x45, 0x6e,
	0x75, 0x6d, 0x31, 0x12, 0x08, 0x0a, 0x04, 0x5a, 0x65, 0x72, 0x6f, 0x10, 0x00, 0x12, 0x07, 0x0a,
	...
	0x22, 0xda, 0x02, 0x0a, 0x08, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x31, 0x12, 0x21, 0x0a,
	...
	0xa2, 0x1f, 0x00, 0x52, 0x08, 0x66, 0x53, 0x74, 0x72, 0x69, 0x6e, 0x67, 0x33, 0x2a, 0x74, 0x0a,
	...
	0x6e, 0x10, 0x11, 0x42, 0x3c, 0x5a, 0x3a, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f,
	0x6d, 0x2f, 0x79, 0x75, 0x33, 0x31, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x2d, 0x70, 0x6c,
	0x75, 0x67, 0x69, 0x6e, 0x2d, 0x6a, 0x73, 0x6f, 0x6e, 0x2f, 0x78, 0x67, 0x6f, 0x2f, 0x74, 0x65,
	0x73, 0x74, 0x73, 0x2f, 0x70, 0x62, 0x2f, 0x70, 0x62, 0x65, 0x78, 0x74, 0x65, 0x72, 0x6e, 0x61,
...
var file_tests_proto_module_external_proto_goTypes = []interface{}{
	(Enum1)(0),                     // 0: external.Enum1
	(Embed_Enum1)(0),               // 1: external.Embed.Enum1
	(Embed_Message_Enum1)(0),       // 2: external.Embed.Message.Enum1
