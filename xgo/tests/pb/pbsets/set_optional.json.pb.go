...
// MarshalJSON implements interface json.Marshaler for proto message TypeSetOptional1 in file tests/proto/cases/sets/set_optional.proto
func (x *TypeSetOptional1) MarshalJSON() ([]byte, error) {
	if x == nil {
		return []byte("null"), nil
	}
	var err error
	encoder := jsonencoder.New(804)
...
// UnmarshalJSON implements json.Unmarshaler for proto message TypeSetOptional1 in file tests/proto/cases/sets/set_optional.proto
func (x *TypeSetOptional1) UnmarshalJSON(b []byte) error {
	if x == nil {
		return errors.New("json: Unmarshal: xgo/tests/pb/pbsets.(*TypeSetOptional1) is nil")
	}
