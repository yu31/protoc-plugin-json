...
// MarshalJSON implements interface json.Marshaler for proto message MessageLevel40 in file tests/proto/cases/inline/inline_message40.proto
...
// UnmarshalJSON implements json.Unmarshaler for proto message MessageLevel40 in file tests/proto/cases/inline/inline_message40.proto
func (x *MessageLevel40) UnmarshalJSON(b []byte) error {
	if x == nil {
		return jsondecoder.ErrStructIsNIL("xgo/tests/pb/pbinline", "MessageLevel40")
	}
	var (
		err    error
		isNULL bool
...
LOOP_SCAN:
	for { // Loop to read the JSON objects
		...
		case "level40_c_p_string1":
			if x.Level40PString1, err = jsondecoder.ReadPtrStr(dec, x.Level40PString1); err != nil {
				return err
			}
		case "level40_p_string2":
			if x.Level40PString2, err = jsondecoder.ReadPtrStr(dec, x.Level40PString2); err != nil {
				return err
			}
