...
// MarshalJSON implements interface json.Marshaler for proto message InlineMessageCircular7 in file tests/proto/cases/boundary/circular7.proto
func (x *InlineMessageCircular7) MarshalJSON() ([]byte, error) {
	if x == nil {
	...
	if a1_3 := x.FMessage1; a1_3 != nil {
		...
		case *InlineMessageCircular7_EmbedMessage1_FMessage2:
			if p2_7 := o2_6.FMessage2; p2_7 != nil {
				...
				if p2_7.OneType3 != nil {
					...
					case *InlineMessageCircular7_EmbedMessage2_FMessage3:
						if err := jsonencoder.AppendValMessage(enc, "f_message3", o3_10.FMessage3, false); err != nil {
							return nil, err
						}
					case *InlineMessageCircular7_EmbedMessage2_FString9:
						jsonencoder.AppendValStr(enc, "f_string9", o3_10.FString9, false)
					case *InlineMessageCircular7_EmbedMessage2_FString10:
		...
		case *InlineMessageCircular7_EmbedMessage1_FString5:
			jsonencoder.AppendValStr(enc, "f_string5", o2_6.FString5, false)
		case *InlineMessageCircular7_EmbedMessage1_FString6:
...
// UnmarshalJSON implements json.Unmarshaler for proto message InlineMessageCircular7 in file tests/proto/cases/boundary/circular7.proto
func (x *InlineMessageCircular7) UnmarshalJSON(b []byte) error {
	if x == nil {
		return errors.New("json: Unmarshal: xgo/tests/pb/pbboundary.(*InlineMessageCircular7) is nil")
	}
	var (
		err    error
		isNULL bool
	...
	var (
		a1_3 *InlineMessageCircular7_EmbedMessage1
		p2_7 *InlineMessageCircular7_EmbedMessage2
	)
	...
	init_a1_3 := func() error {
		if a1_3 == nil {
			if x.FMessage1 == nil {
				x.FMessage1 = new(InlineMessageCircular7_EmbedMessage1)
			}
			a1_3 = x.FMessage1
		}
		return nil
	...
	init_p2_7 := func() error {
		if p2_7 == nil {
			...
			isLoad_o2_6 = true
			o2_6, ok := a1_3.OneType2.(*InlineMessageCircular7_EmbedMessage1_FMessage2)
			if !ok {
				o2_6 = new(InlineMessageCircular7_EmbedMessage1_FMessage2)
				a1_3.OneType2 = o2_6
			}
			if o2_6.FMessage2 == nil {
				o2_6.FMessage2 = new(InlineMessageCircular7_EmbedMessage2)
			}
			p2_7 = o2_6.FMessage2
		}
		return nil
...
LOOP_SCAN:
	for { // Loop to read the JSON objects
			...
			if isNULL {
				...
				for { // Loop to read oneof fields
					...
					case "f_message3":
						...
						isLoad_o3_10 = true
						o3_10, ok := p2_7.OneType3.(*InlineMessageCircular7_EmbedMessage2_FMessage3)
						if !ok {
							o3_10 = new(InlineMessageCircular7_EmbedMessage2_FMessage3)
							p2_7.OneType3 = o3_10
						}
					...
					case "f_string9":
						...
						isLoad_o3_10 = true
						o3_10, ok := p2_7.OneType3.(*InlineMessageCircular7_EmbedMessage2_FString9)
						if !ok {
							o3_10 = new(InlineMessageCircular7_EmbedMessage2_FString9)
							p2_7.OneType3 = o3_10
						}
					...
					case "f_string10":
						...
						isLoad_o3_10 = true
						o3_10, ok := p2_7.OneType3.(*InlineMessageCircular7_EmbedMessage2_FString10)
						if !ok {
							o3_10 = new(InlineMessageCircular7_EmbedMessage2_FString10)
							p2_7.OneType3 = o3_10
						}
		...
		case "f_string5":
			...
			isLoad_o2_6 = true
			o2_6, ok := a1_3.OneType2.(*InlineMessageCircular7_EmbedMessage1_FString5)
			if !ok {
				o2_6 = new(InlineMessageCircular7_EmbedMessage1_FString5)
				a1_3.OneType2 = o2_6
			}
		...
		case "f_string6":
			...
			isLoad_o2_6 = true
			o2_6, ok := a1_3.OneType2.(*InlineMessageCircular7_EmbedMessage1_FString6)
			if !ok {
				o2_6 = new(InlineMessageCircular7_EmbedMessage1_FString6)
				a1_3.OneType2 = o2_6
			}
...
// MarshalJSON implements interface json.Marshaler for proto message EmbedMessage1 in file tests/proto/cases/boundary/circular7.proto
func (x *InlineMessageCircular7_EmbedMessage1) MarshalJSON() ([]byte, error) {
	if x == nil {
		return []byte("null"), nil
	}
...
// UnmarshalJSON implements json.Unmarshaler for proto message EmbedMessage1 in file tests/proto/cases/boundary/circular7.proto
func (x *InlineMessageCircular7_EmbedMessage1) UnmarshalJSON(b []byte) error {
	if x == nil {
		return errors.New("json: Unmarshal: xgo/tests/pb/pbboundary.(*InlineMessageCircular7_EmbedMessage1) is nil")
	}
	var (
		err    error
		isNULL bool
	...
	// declares variables to simple to reference parent field
	var (
		p1_4 *InlineMessageCircular7_EmbedMessage2
	)
	...
	init_p1_4 := func() error {
		if p1_4 == nil {
			...
			isLoad_o1_3 = true
			o1_3, ok := x.OneType2.(*InlineMessageCircular7_EmbedMessage1_FMessage2)
			if !ok {
				o1_3 = new(InlineMessageCircular7_EmbedMessage1_FMessage2)
				x.OneType2 = o1_3
			}
			if o1_3.FMessage2 == nil {
				o1_3.FMessage2 = new(InlineMessageCircular7_EmbedMessage2)
			}
			p1_4 = o1_3.FMessage2
		}
		return nil
...
LOOP_SCAN:
	for { // Loop to read the JSON objects
			...
			if isNULL {
				...
				for { // Loop to read oneof fields
					...
					case "f_message3":
						...
						isLoad_o2_7 = true
						o2_7, ok := p1_4.OneType3.(*InlineMessageCircular7_EmbedMessage2_FMessage3)
						if !ok {
							o2_7 = new(InlineMessageCircular7_EmbedMessage2_FMessage3)
							p1_4.OneType3 = o2_7
						}
					...
					case "f_string9":
						...
						isLoad_o2_7 = true
						o2_7, ok := p1_4.OneType3.(*InlineMessageCircular7_EmbedMessage2_FString9)
						if !ok {
							o2_7 = new(InlineMessageCircular7_EmbedMessage2_FString9)
							p1_4.OneType3 = o2_7
						}
					...
					case "f_string10":
						...
						isLoad_o2_7 = true
						o2_7, ok := p1_4.OneType3.(*InlineMessageCircular7_EmbedMessage2_FString10)
						if !ok {
							o2_7 = new(InlineMessageCircular7_EmbedMessage2_FString10)
							p1_4.OneType3 = o2_7
						}
		...
		case "f_string5":
			...
			isLoad_o1_3 = true
			o1_3, ok := x.OneType2.(*InlineMessageCircular7_EmbedMessage1_FString5)
			if !ok {
				o1_3 = new(InlineMessageCircular7_EmbedMessage1_FString5)
				x.OneType2 = o1_3
			}
		...
		case "f_string6":
			...
			isLoad_o1_3 = true
			o1_3, ok := x.OneType2.(*InlineMessageCircular7_EmbedMessage1_FString6)
			if !ok {
				o1_3 = new(InlineMessageCircular7_EmbedMessage1_FString6)
				x.OneType2 = o1_3
			}
...
// MarshalJSON implements interface json.Marshaler for proto message EmbedMessage2 in file tests/proto/cases/boundary/circular7.proto
func (x *InlineMessageCircular7_EmbedMessage2) MarshalJSON() ([]byte, error) {
	if x == nil {
		return []byte("null"), nil
	}
	enc := jsonencoder.New(144)
...
// UnmarshalJSON implements json.Unmarshaler for proto message EmbedMessage2 in file tests/proto/cases/boundary/circular7.proto
func (x *InlineMessageCircular7_EmbedMessage2) UnmarshalJSON(b []byte) error {
	if x == nil {
		return errors.New("json: Unmarshal: xgo/tests/pb/pbboundary.(*InlineMessageCircular7_EmbedMessage2) is nil")
	}
	var (
		err    error
		isNULL bool
			...
			if isNULL {
				...
				for { // Loop to read oneof fields
					...
					case "f_message3":
						...
						isLoad_o1_3 = true
						o1_3, ok := x.OneType3.(*InlineMessageCircular7_EmbedMessage2_FMessage3)
						if !ok {
							o1_3 = new(InlineMessageCircular7_EmbedMessage2_FMessage3)
							x.OneType3 = o1_3
						}
					...
					case "f_string9":
						...
						isLoad_o1_3 = true
						o1_3, ok := x.OneType3.(*InlineMessageCircular7_EmbedMessage2_FString9)
						if !ok {
							o1_3 = new(InlineMessageCircular7_EmbedMessage2_FString9)
							x.OneType3 = o1_3
						}
					...
					case "f_string10":
						...
						isLoad_o1_3 = true
						o1_3, ok := x.OneType3.(*InlineMessageCircular7_EmbedMessage2_FString10)
						if !ok {
							o1_3 = new(InlineMessageCircular7_EmbedMessage2_FString10)
							x.OneType3 = o1_3
						}
