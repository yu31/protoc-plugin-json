...
// Complex1 for test cases. multiple space between field.
...
var file_tests_proto_cases_boundary_boundary1_proto_rawDesc = []byte{
	...
	0x38, 0x01, 0x42, 0x0a, 0x0a, 0x08, 0x5f, 0x66, 0x5f, 0x69, 0x6e, 0x74, 0x36, 0x34, 0x42, 0x19,
...
var file_tests_proto_cases_boundary_boundary1_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_tests_proto_cases_boundary_boundary1_proto_goTypes = []interface{}{
	...
	nil,               // 4: type_common.Map1.MString1Entry
	nil,               // 5: type_common.Complex1.MInt32Entry
}
var file_tests_proto_cases_boundary_boundary1_proto_depIdxs = []int32{
	4, // 0: type_common.Map1.m_string1:type_name -> type_common.Map1.MString1Entry
	0, // 1: type_common.Complex1.f_message1:type_name -> type_common.Message1
	5, // 2: type_common.Complex1.m_int32:type_name -> type_common.Complex1.MInt32Entry
