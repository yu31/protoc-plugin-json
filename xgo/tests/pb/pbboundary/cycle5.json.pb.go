...
func (x *InlineMessageCycle5) UnmarshalJSON(b []byte) error {
	if x == nil {
		return errors.New("json: Unmarshal: xgo/tests/pb/pbboundary.(*InlineMessageCycle5) is nil")
	}
	var (
		err    error
		isNULL bool
...
func (x *InlineMessageCycle5_EmbedMessage1) UnmarshalJSON(b []byte) error {
	if x == nil {
		return errors.New("json: Unmarshal: xgo/tests/pb/pbboundary.(*InlineMessageCycle5_EmbedMessage1) is nil")
	}
	var (
		err    error
		isNULL bool
