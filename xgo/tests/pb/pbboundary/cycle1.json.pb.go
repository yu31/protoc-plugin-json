...
func (x *InlineMessageCycle1) UnmarshalJSON(b []byte) error {
	if x == nil {
		return jsondecoder.ErrStructIsNIL("xgo/tests/pb/pbboundary", "InlineMessageCycle1")
	}
	var (
		err    error
		isNULL bool
...
func (x *InlineMessageCycle1_EmbedMessage1) UnmarshalJSON(b []byte) error {
	if x == nil {
		return jsondecoder.ErrStructIsNIL("xgo/tests/pb/pbboundary", "InlineMessageCycle1_EmbedMessage1")
	}
	var (
		err    error
		isNULL bool
