...
// MarshalJSON implements interface json.Marshaler for proto message InlineMessageCircular1 in file tests/proto/cases/boundary/circular1.proto
func (x *InlineMessageCircular1) MarshalJSON() ([]byte, error) {
	if x == nil {
...
// UnmarshalJSON implements json.Unmarshaler for proto message InlineMessageCircular1 in file tests/proto/cases/boundary/circular1.proto
func (x *InlineMessageCircular1) UnmarshalJSON(b []byte) error {
	if x == nil {
		return errors.New("json: Unmarshal: xgo/tests/pb/pbboundary.(*InlineMessageCircular1) is nil")
	}
	var (
		err    error
		isNULL bool
	...
	var (
		a1_3 *InlineMessageCircular1_EmbedMessage1
	)
	...
	init_a1_3 := func() error {
		if a1_3 == nil {
			if x.FMessage1 == nil {
				x.FMessage1 = new(InlineMessageCircular1_EmbedMessage1)
			}
			a1_3 = x.FMessage1
		}
		return nil
...
// MarshalJSON implements interface json.Marshaler for proto message EmbedMessage1 in file tests/proto/cases/boundary/circular1.proto
func (x *InlineMessageCircular1_EmbedMessage1) MarshalJSON() ([]byte, error) {
	if x == nil {
		return []byte("null"), nil
	}
	enc := jsonencoder.New(80)
...
// UnmarshalJSON implements json.Unmarshaler for proto message EmbedMessage1 in file tests/proto/cases/boundary/circular1.proto
func (x *InlineMessageCircular1_EmbedMessage1) UnmarshalJSON(b []byte) error {
	if x == nil {
		return errors.New("json: Unmarshal: xgo/tests/pb/pbboundary.(*InlineMessageCircular1_EmbedMessage1) is nil")
	}
	var (
		err    error
		isNULL bool
