...
func (x *InlineMessageCycle2) UnmarshalJSON(b []byte) error {
	if x == nil {
		return jsondecoder.ErrStructIsNIL("xgo/tests/pb/pbboundary", "InlineMessageCycle2")
	}
	var (
		err    error
		isNULL bool
...
func (x *InlineMessageCycle2_EmbedMessage1) UnmarshalJSON(b []byte) error {
	if x == nil {
		return jsondecoder.ErrStructIsNIL("xgo/tests/pb/pbboundary", "InlineMessageCycle2_EmbedMessage1")
	}
	var (
		err    error
		isNULL bool
...
func (x *InlineMessageCycle2_EmbedMessage2) UnmarshalJSON(b []byte) error {
	if x == nil {
		return jsondecoder.ErrStructIsNIL("xgo/tests/pb/pbboundary", "InlineMessageCycle2_EmbedMessage2")
	}
	var (
		err    error
		isNULL bool
