...
// MarshalJSON implements interface json.Marshaler for proto message InlineMessageCircular4 in file tests/proto/cases/boundary/circular4.proto
func (x *InlineMessageCircular4) MarshalJSON() ([]byte, error) {
	if x == nil {
	...
	if a1_3 := x.FMessage1; a1_3 != nil {
		...
		if a1_3.OneType2 != nil {
			...
			case *InlineMessageCircular4_EmbedMessage1_FMessage2:
				if err := jsonencoder.AppendValMessage(enc, "f_message2", o2_6.FMessage2, false); err != nil {
					return nil, err
				}
			case *InlineMessageCircular4_EmbedMessage1_FString5:
				jsonencoder.AppendValStr(enc, "f_string5", o2_6.FString5, false)
			case *InlineMessageCircular4_EmbedMessage1_FString6:
...
// UnmarshalJSON implements json.Unmarshaler for proto message InlineMessageCircular4 in file tests/proto/cases/boundary/circular4.proto
func (x *InlineMessageCircular4) UnmarshalJSON(b []byte) error {
	if x == nil {
		return errors.New("json: Unmarshal: xgo/tests/pb/pbboundary.(*InlineMessageCircular4) is nil")
	}
	var (
		err    error
		isNULL bool
	...
	var (
		a1_3 *InlineMessageCircular4_EmbedMessage1
	)
	...
	init_a1_3 := func() error {
		if a1_3 == nil {
			if x.FMessage1 == nil {
				x.FMessage1 = new(InlineMessageCircular4_EmbedMessage1)
			}
			a1_3 = x.FMessage1
		}
		return nil
			...
			if isNULL {
				...
				for { // Loop to read oneof fields
					...
					case "f_message2":
						...
						isLoad_o2_6 = true
						o2_6, ok := a1_3.OneType2.(*InlineMessageCircular4_EmbedMessage1_FMessage2)
						if !ok {
							o2_6 = new(InlineMessageCircular4_EmbedMessage1_FMessage2)
							a1_3.OneType2 = o2_6
						}
					...
					case "f_string5":
						...
						isLoad_o2_6 = true
						o2_6, ok := a1_3.OneType2.(*InlineMessageCircular4_EmbedMessage1_FString5)
						if !ok {
							o2_6 = new(InlineMessageCircular4_EmbedMessage1_FString5)
							a1_3.OneType2 = o2_6
						}
					...
					case "f_string6":
						...
						isLoad_o2_6 = true
						o2_6, ok := a1_3.OneType2.(*InlineMessageCircular4_EmbedMessage1_FString6)
						if !ok {
							o2_6 = new(InlineMessageCircular4_EmbedMessage1_FString6)
							a1_3.OneType2 = o2_6
						}
...
// MarshalJSON implements interface json.Marshaler for proto message EmbedMessage1 in file tests/proto/cases/boundary/circular4.proto
func (x *InlineMessageCircular4_EmbedMessage1) MarshalJSON() ([]byte, error) {
	if x == nil {
		return []byte("null"), nil
	}
...
// UnmarshalJSON implements json.Unmarshaler for proto message EmbedMessage1 in file tests/proto/cases/boundary/circular4.proto
func (x *InlineMessageCircular4_EmbedMessage1) UnmarshalJSON(b []byte) error {
	if x == nil {
		return errors.New("json: Unmarshal: xgo/tests/pb/pbboundary.(*InlineMessageCircular4_EmbedMessage1) is nil")
	}
	var (
		err    error
		isNULL bool
			...
			if isNULL {
				...
				for { // Loop to read oneof fields
					...
					case "f_message2":
						...
						isLoad_o1_3 = true
						o1_3, ok := x.OneType2.(*InlineMessageCircular4_EmbedMessage1_FMessage2)
						if !ok {
							o1_3 = new(InlineMessageCircular4_EmbedMessage1_FMessage2)
							x.OneType2 = o1_3
						}
					...
					case "f_string5":
						...
						isLoad_o1_3 = true
						o1_3, ok := x.OneType2.(*InlineMessageCircular4_EmbedMessage1_FString5)
						if !ok {
							o1_3 = new(InlineMessageCircular4_EmbedMessage1_FString5)
							x.OneType2 = o1_3
						}
					...
					case "f_string6":
						...
						isLoad_o1_3 = true
						o1_3, ok := x.OneType2.(*InlineMessageCircular4_EmbedMessage1_FString6)
						if !ok {
							o1_3 = new(InlineMessageCircular4_EmbedMessage1_FString6)
							x.OneType2 = o1_3
						}
