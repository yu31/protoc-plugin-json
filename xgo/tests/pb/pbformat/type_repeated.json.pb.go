...
// MarshalJSON implements interface json.Marshaler for proto message TypeRepeated1 in file tests/proto/cases/format/type_repeated.proto
...
// UnmarshalJSON implements json.Unmarshaler for proto message TypeRepeated1 in file tests/proto/cases/format/type_repeated.proto
func (x *TypeRepeated1) UnmarshalJSON(b []byte) error {
	if x == nil {
		return errors.New("json: Unmarshal: xgo/tests/pb/pbformat.(*TypeRepeated1) is nil")
	}
	var (
		err    error
		isNULL bool
...
// MarshalJSON implements interface json.Marshaler for proto message TypeRepeated2 in file tests/proto/cases/format/type_repeated.proto
...
// UnmarshalJSON implements json.Unmarshaler for proto message TypeRepeated2 in file tests/proto/cases/format/type_repeated.proto
func (x *TypeRepeated2) UnmarshalJSON(b []byte) error {
	if x == nil {
		return errors.New("json: Unmarshal: xgo/tests/pb/pbformat.(*TypeRepeated2) is nil")
	}
	var (
		err    error
		isNULL bool
