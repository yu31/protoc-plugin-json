...
// 	protoc        v3.19.3
// source: tests/proto/cases/format/private.proto
...
func (Enum1) Descriptor() protoreflect.EnumDescriptor {
	return file_tests_proto_cases_format_private_proto_enumTypes[0].Descriptor()
}

func (Enum1) Type() protoreflect.EnumType {
	return &file_tests_proto_cases_format_private_proto_enumTypes[0]
}
...
func (Enum1) EnumDescriptor() ([]byte, []int) {
	return file_tests_proto_cases_format_private_proto_rawDescGZIP(), []int{0}
}
...
func (x *Message1) Reset() {
	*x = Message1{}
	if protoimpl.UnsafeEnabled {
		mi := &file_tests_proto_cases_format_private_proto_msgTypes[0]
...
func (x *Message1_Embed1) Reset() {
	*x = Message1_Embed1{}
	if protoimpl.UnsafeEnabled {
		mi := &file_tests_proto_cases_format_private_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Message1_Embed1) Descriptor() ([]byte, []int) {
	return file_tests_proto_cases_format_private_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *Message1_Embed1_Embed2) Reset() {
	*x = Message1_Embed1_Embed2{}
	if protoimpl.UnsafeEnabled {
		mi := &file_tests_proto_cases_format_private_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Message1_Embed1_Embed2) Descriptor() ([]byte, []int) {
	return file_tests_proto_cases_format_private_proto_rawDescGZIP(), []int{0, 0, 0}
}
...
var File_tests_proto_cases_format_private_proto protoreflect.FileDescriptor

var file_tests_proto_cases_format_private_proto_rawDesc = []byte{
	0x0a, 0x26, 0x74, 0x65, 0x73, 0x74, 0x73, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x63, 0x61,
	0x73, 0x65, 0x73, 0x2f, 0x66, 0x6f, 0x72, 0x6d, 0x61, 0x74, 0x2f, 0x70, 0x72, 0x69, 0x76, 0x61,
	...
	0x6f, 0x74, 0x6f, 0x22, 0xda, 0x02, 0x0a, 0x08, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x31,
	...
	0x2a, 0x74, 0x0a, 0x05, 0x45, 0x6e, 0x75, 0x6d, 0x31, 0x12, 0x08, 0x0a, 0x04, 0x5a, 0x65, 0x72,
	...
	0x03, 0x54, 0x65, 0x6e, 0x10, 0x11, 0x42, 0x17, 0x5a, 0x15, 0x78, 0x67, 0x6f, 0x2f, 0x74, 0x65,
	0x73, 0x74, 0x73, 0x2f, 0x70, 0x62, 0x2f, 0x70, 0x62, 0x66, 0x6f, 0x72, 0x6d, 0x61, 0x74, 0x62,
	0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_tests_proto_cases_format_private_proto_rawDescOnce sync.Once
	file_tests_proto_cases_format_private_proto_rawDescData = file_tests_proto_cases_format_private_proto_rawDesc
)

func file_tests_proto_cases_format_private_proto_rawDescGZIP() []byte {
	file_tests_proto_cases_format_private_proto_rawDescOnce.Do(func() {
		file_tests_proto_cases_format_private_proto_rawDescData = protoimpl.X.CompressGZIP(file_tests_proto_cases_format_private_proto_rawDescData)
	})
	return file_tests_proto_cases_format_private_proto_rawDescData
}

var file_tests_proto_cases_format_private_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_tests_proto_cases_format_private_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_tests_proto_cases_format_private_proto_goTypes = []interface{}{
...
var file_tests_proto_cases_format_private_proto_depIdxs = []int32{
...
func init() { file_tests_proto_cases_format_private_proto_init() }
func file_tests_proto_cases_format_private_proto_init() {
	if File_tests_proto_cases_format_private_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_tests_proto_cases_format_private_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_tests_proto_cases_format_private_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_tests_proto_cases_format_private_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_tests_proto_cases_format_private_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_tests_proto_cases_format_private_proto_goTypes,
		DependencyIndexes: file_tests_proto_cases_format_private_proto_depIdxs,
		EnumInfos:         file_tests_proto_cases_format_private_proto_enumTypes,
		MessageInfos:      file_tests_proto_cases_format_private_proto_msgTypes,
	}.Build()
	File_tests_proto_cases_format_private_proto = out.File
	file_tests_proto_cases_format_private_proto_rawDesc = nil
	file_tests_proto_cases_format_private_proto_goTypes = nil
	file_tests_proto_cases_format_private_proto_depIdxs = nil
}
