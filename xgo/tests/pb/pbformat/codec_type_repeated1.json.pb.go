...
func (x *CodecTypeRepeated1) MarshalJSON() ([]byte, error) {
	...
	jsonencoder.AppendListEnumNum(enc, "f_enum_numeric", x.FEnumNumeric, false, false)
	jsonencoder.AppendListEnumNum(enc, "f_enum_numeric_string", x.FEnumNumericString, false, true)
	jsonencoder.AppendListEnumStr(enc, "f_enum_string", x.FEnumString, false)
	if err := jsonencoder.AppendListWKTAnyObject(enc, "f_any_native", x.FAnyNative, false); err != nil {
		return nil, err
	}
	if err := jsonencoder.AppendListWKTAnyProto(enc, "f_any_proto", x.FAnyProto, false); err != nil {
		return nil, err
	}
	if err := jsonencoder.AppendListWKTDurObject(enc, "f_duration_native", x.FDurationNative, false); err != nil {
		return nil, err
	}
	jsonencoder.AppendListWKTDurTimeStr(enc, "f_duration_string", x.FDurationString, false)
	jsonencoder.AppendListWKTDurNano(enc, "f_duration_nanosecond", x.FDurationNanosecond, false, false)
	jsonencoder.AppendListWKTDurNano(enc, "f_duration_nanosecond_string", x.FDurationNanosecondString, false, true)
	jsonencoder.AppendListWKTDurMicro(enc, "f_duration_microsecond", x.FDurationMicrosecond, false, false)
	jsonencoder.AppendListWKTDurMicro(enc, "f_duration_microsecond_string", x.FDurationMicrosecondString, false, true)
	jsonencoder.AppendListWKTDurMilli(enc, "f_duration_millisecond", x.FDurationMillisecond, false, false)
	jsonencoder.AppendListWKTDurMilli(enc, "f_duration_millisecond_string", x.FDurationMillisecondString, false, true)
	jsonencoder.AppendListWKTDurSecond(enc, "f_duration_second", x.FDurationSecond, false, false)
	jsonencoder.AppendListWKTDurSecond(enc, "f_duration_second_string", x.FDurationSecondString, false, true)
	jsonencoder.AppendListWKTDurMinute(enc, "f_duration_minute", x.FDurationMinute, false, false)
	jsonencoder.AppendListWKTDurMinute(enc, "f_duration_minute_string", x.FDurationMinuteString, false, true)
	jsonencoder.AppendListWKTDurHour(enc, "f_duration_hour", x.FDurationHour, false, false)
	jsonencoder.AppendListWKTDurHour(enc, "f_duration_hour_string", x.FDurationHourString, false, true)
	if err := jsonencoder.AppendListWKTTsObject(enc, "f_timestamp_native", x.FTimestampNative, false); err != nil {
		return nil, err
	}
	jsonencoder.AppendListWKTTsLayout(enc, "f_timestamp_time_layout", x.FTimestampTimeLayout, false, "2006-01-02T15:04:05Z07:00")
	jsonencoder.AppendListWKTTsUnixNano(enc, "f_timestamp_unix_nano", x.FTimestampUnixNano, false, false)
	jsonencoder.AppendListWKTTsUnixNano(enc, "f_timestamp_unix_nano_string", x.FTimestampUnixNanoString, false, true)
	jsonencoder.AppendListWKTTsUnixMicro(enc, "f_timestamp_unix_micro", x.FTimestampUnixMicro, false, false)
	jsonencoder.AppendListWKTTsUnixMicro(enc, "f_timestamp_unix_micro_string", x.FTimestampUnixMicroString, false, true)
	jsonencoder.AppendListWKTTsUnixMilli(enc, "f_timestamp_unix_milli", x.FTimestampUnixMilli, false, false)
	jsonencoder.AppendListWKTTsUnixMilli(enc, "f_timestamp_unix_milli_string", x.FTimestampUnixMilliString, false, true)
	jsonencoder.AppendListWKTTsUnixSec(enc, "f_timestamp_unix_sec", x.FTimestampUnixSec, false, false)
	jsonencoder.AppendListWKTTsUnixSec(enc, "f_timestamp_unix_sec_string", x.FTimestampUnixSecString, false, true)
...
LOOP_SCAN:
	for { // Loop to read the JSON objects
		...
		case "f_enum_numeric":
			if x.FEnumNumeric, err = jsondecoder.ReadListEnumNum(dec, x.FEnumNumeric, false); err != nil {
				return err
			}
		case "f_enum_numeric_string":
			if x.FEnumNumericString, err = jsondecoder.ReadListEnumNum(dec, x.FEnumNumericString, true); err != nil {
				return err
			}
		case "f_enum_string":
			if x.FEnumString, err = jsondecoder.ReadListEnumStr(dec, x.FEnumString, pbexternal.EnumNum1_value); err != nil {
				return err
			}
		case "f_any_native":
			if x.FAnyNative, err = jsondecoder.ReadListWKTAnyObject(dec, x.FAnyNative); err != nil {
				return err
			}
		case "f_any_proto":
			if x.FAnyProto, err = jsondecoder.ReadListWKTAnyProto(dec, x.FAnyProto); err != nil {
				return err
			}
		case "f_duration_native":
			if x.FDurationNative, err = jsondecoder.ReadListWKTDurObject(dec, x.FDurationNative); err != nil {
				return err
			}
		case "f_duration_string":
			if x.FDurationString, err = jsondecoder.ReadListWKTDurTimeStr(dec, x.FDurationString); err != nil {
				return err
			}
		case "f_duration_nanosecond":
			if x.FDurationNanosecond, err = jsondecoder.ReadListWKTDurNano(dec, x.FDurationNanosecond, false); err != nil {
				return err
			}
		case "f_duration_nanosecond_string":
			if x.FDurationNanosecondString, err = jsondecoder.ReadListWKTDurNano(dec, x.FDurationNanosecondString, true); err != nil {
				return err
			}
		case "f_duration_microsecond":
			if x.FDurationMicrosecond, err = jsondecoder.ReadListWKTDurMicro(dec, x.FDurationMicrosecond, false); err != nil {
				return err
			}
		case "f_duration_microsecond_string":
			if x.FDurationMicrosecondString, err = jsondecoder.ReadListWKTDurMicro(dec, x.FDurationMicrosecondString, true); err != nil {
				return err
			}
		case "f_duration_millisecond":
			if x.FDurationMillisecond, err = jsondecoder.ReadListWKTDurMilli(dec, x.FDurationMillisecond, false); err != nil {
				return err
			}
		case "f_duration_millisecond_string":
			if x.FDurationMillisecondString, err = jsondecoder.ReadListWKTDurMilli(dec, x.FDurationMillisecondString, true); err != nil {
				return err
			}
		case "f_duration_second":
			if x.FDurationSecond, err = jsondecoder.ReadListWKTDurSecond(dec, x.FDurationSecond, false); err != nil {
				return err
			}
		case "f_duration_second_string":
			if x.FDurationSecondString, err = jsondecoder.ReadListWKTDurSecond(dec, x.FDurationSecondString, true); err != nil {
				return err
			}
		case "f_duration_minute":
			if x.FDurationMinute, err = jsondecoder.ReadListWKTDurMinute(dec, x.FDurationMinute, false); err != nil {
				return err
			}
		case "f_duration_minute_string":
			if x.FDurationMinuteString, err = jsondecoder.ReadListWKTDurMinute(dec, x.FDurationMinuteString, true); err != nil {
				return err
			}
		case "f_duration_hour":
			if x.FDurationHour, err = jsondecoder.ReadListWKTDurHour(dec, x.FDurationHour, false); err != nil {
				return err
			}
		case "f_duration_hour_string":
			if x.FDurationHourString, err = jsondecoder.ReadListWKTDurHour(dec, x.FDurationHourString, true); err != nil {
				return err
			}
		case "f_timestamp_native":
			if x.FTimestampNative, err = jsondecoder.ReadListWKTTsObject(dec, x.FTimestampNative); err != nil {
				return err
			}
		case "f_timestamp_time_layout":
			if x.FTimestampTimeLayout, err = jsondecoder.ReadListWKTTsLayout(dec, x.FTimestampTimeLayout, "2006-01-02T15:04:05Z07:00"); err != nil {
				return err
			}
		case "f_timestamp_unix_nano":
			if x.FTimestampUnixNano, err = jsondecoder.ReadListWKTTsUnixNano(dec, x.FTimestampUnixNano, false); err != nil {
				return err
			}
		case "f_timestamp_unix_nano_string":
			if x.FTimestampUnixNanoString, err = jsondecoder.ReadListWKTTsUnixNano(dec, x.FTimestampUnixNanoString, true); err != nil {
				return err
			}
		case "f_timestamp_unix_micro":
			if x.FTimestampUnixMicro, err = jsondecoder.ReadListWKTTsUnixMicro(dec, x.FTimestampUnixMicro, false); err != nil {
				return err
			}
		case "f_timestamp_unix_micro_string":
			if x.FTimestampUnixMicroString, err = jsondecoder.ReadListWKTTsUnixMicro(dec, x.FTimestampUnixMicroString, true); err != nil {
				return err
			}
		case "f_timestamp_unix_milli":
			if x.FTimestampUnixMilli, err = jsondecoder.ReadListWKTTsUnixMilli(dec, x.FTimestampUnixMilli, false); err != nil {
				return err
			}
		case "f_timestamp_unix_milli_string":
			if x.FTimestampUnixMilliString, err = jsondecoder.ReadListWKTTsUnixMilli(dec, x.FTimestampUnixMilliString, true); err != nil {
				return err
			}
		case "f_timestamp_unix_sec":
			if x.FTimestampUnixSec, err = jsondecoder.ReadListWKTTsUnixSec(dec, x.FTimestampUnixSec, false); err != nil {
				return err
			}
		case "f_timestamp_unix_sec_string":
			if x.FTimestampUnixSecString, err = jsondecoder.ReadListWKTTsUnixSec(dec, x.FTimestampUnixSecString, true); err != nil {
				return err
			}
		default:
