...
// MarshalJSON implements interface json.Marshaler for proto message WKTOneOf1 in file tests/proto/cases/format/wkt_oneof.proto
...
// UnmarshalJSON implements json.Unmarshaler for proto message WKTOneOf1 in file tests/proto/cases/format/wkt_oneof.proto
func (x *WKTOneOf1) UnmarshalJSON(b []byte) error {
	if x == nil {
		return errors.New("json: Unmarshal: xgo/tests/pb/pbformat.(*WKTOneOf1) is nil")
	}
	var (
		err    error
		isNULL bool
