...
// MarshalJSON implements interface json.Marshaler for proto message MessageLevel11 in file tests/proto/cases/inlines/inline_message11.proto
...
// UnmarshalJSON implements json.Unmarshaler for proto message MessageLevel11 in file tests/proto/cases/inlines/inline_message11.proto
func (x *MessageLevel11) UnmarshalJSON(b []byte) error {
	if x == nil {
		return errors.New("json: Unmarshal: xgo/tests/pb/pbinlines.(*MessageLevel11) is nil")
	}
	var (
		err    error
		isNULL bool
...
LOOP_SCAN:
	for { // Loop to read the JSON objects
		...
		case "level11_c_p_string1":
			if x.Level11PString1, err = jsondecoder.ReadPtrStr(dec); err != nil {
				return err
			}
		case "level11_p_string2":
			if x.Level11PString2, err = jsondecoder.ReadPtrStr(dec); err != nil {
				return err
			}
