...
// MarshalJSON implements interface json.Marshaler for proto message MessageLevel15 in file tests/proto/cases/inlines/inline_message15.proto
...
// UnmarshalJSON implements json.Unmarshaler for proto message MessageLevel15 in file tests/proto/cases/inlines/inline_message15.proto
func (x *MessageLevel15) UnmarshalJSON(b []byte) error {
	if x == nil {
		return errors.New("json: Unmarshal: xgo/tests/pb/pbinlines.(*MessageLevel15) is nil")
	}
	var (
		err    error
		isNULL bool
