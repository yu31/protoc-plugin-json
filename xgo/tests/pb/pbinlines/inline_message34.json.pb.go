...
// MarshalJSON implements interface json.Marshaler for proto message MessageLevel34 in file tests/proto/cases/inlines/inline_message34.proto
...
// UnmarshalJSON implements json.Unmarshaler for proto message MessageLevel34 in file tests/proto/cases/inlines/inline_message34.proto
func (x *MessageLevel34) UnmarshalJSON(b []byte) error {
	if x == nil {
		return errors.New("json: Unmarshal: xgo/tests/pb/pbinlines.(*MessageLevel34) is nil")
	}
	var (
		err    error
		isNULL bool
