...
// MarshalJSON implements interface json.Marshaler for proto message MessageLevel24 in file tests/proto/cases/inlines/inline_message24.proto
...
// UnmarshalJSON implements json.Unmarshaler for proto message MessageLevel24 in file tests/proto/cases/inlines/inline_message24.proto
func (x *MessageLevel24) UnmarshalJSON(b []byte) error {
	if x == nil {
		return errors.New("json: Unmarshal: xgo/tests/pb/pbinlines.(*MessageLevel24) is nil")
	}
	var (
		err    error
		isNULL bool
...
LOOP_SCAN:
	for { // Loop to read the JSON objects
		...
		case "level24_c_p_string1":
			if x.Level24PString1, err = jsondecoder.ReadPtrStr(dec); err != nil {
				return err
			}
		case "level24_p_string2":
			if x.Level24PString2, err = jsondecoder.ReadPtrStr(dec); err != nil {
				return err
			}
