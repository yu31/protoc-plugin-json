...
// MarshalJSON implements interface json.Marshaler for proto message MessageLevel05 in file tests/proto/cases/inlines/inline_message05.proto
...
// UnmarshalJSON implements json.Unmarshaler for proto message MessageLevel05 in file tests/proto/cases/inlines/inline_message05.proto
func (x *MessageLevel05) UnmarshalJSON(b []byte) error {
	if x == nil {
		return errors.New("json: Unmarshal: xgo/tests/pb/pbinlines.(*MessageLevel05) is nil")
	}
	var (
		err    error
		isNULL bool
