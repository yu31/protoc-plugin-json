...
// MarshalJSON implements interface json.Marshaler for proto message MessageLevel33 in file tests/proto/cases/inlines/inline_message33.proto
...
// UnmarshalJSON implements json.Unmarshaler for proto message MessageLevel33 in file tests/proto/cases/inlines/inline_message33.proto
func (x *MessageLevel33) UnmarshalJSON(b []byte) error {
	if x == nil {
		return errors.New("json: Unmarshal: xgo/tests/pb/pbinlines.(*MessageLevel33) is nil")
	}
	var (
		err    error
		isNULL bool
...
LOOP_SCAN:
	for { // Loop to read the JSON objects
		...
		case "level33_c_p_string1":
			if x.Level33PString1, err = jsondecoder.ReadPtrStr(dec); err != nil {
				return err
			}
		case "level33_p_string2":
			if x.Level33PString2, err = jsondecoder.ReadPtrStr(dec); err != nil {
				return err
			}
