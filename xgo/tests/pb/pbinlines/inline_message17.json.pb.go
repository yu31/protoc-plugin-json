...
// MarshalJSON implements interface json.Marshaler for proto message MessageLevel17 in file tests/proto/cases/inlines/inline_message17.proto
...
// UnmarshalJSON implements json.Unmarshaler for proto message MessageLevel17 in file tests/proto/cases/inlines/inline_message17.proto
func (x *MessageLevel17) UnmarshalJSON(b []byte) error {
	if x == nil {
		return errors.New("json: Unmarshal: xgo/tests/pb/pbinlines.(*MessageLevel17) is nil")
	}
	var (
		err    error
		isNULL bool
...
LOOP_SCAN:
	for { // Loop to read the JSON objects
		...
		case "level17_c_p_string1":
			if x.Level17PString1, err = jsondecoder.ReadPtrStr(dec); err != nil {
				return err
			}
		case "level17_p_string2":
			if x.Level17PString2, err = jsondecoder.ReadPtrStr(dec); err != nil {
				return err
			}
