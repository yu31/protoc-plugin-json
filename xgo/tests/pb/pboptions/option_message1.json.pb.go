...
// MarshalJSON implements interface json.Marshaler for proto message DisallowUnknownMessage1 in file tests/proto/cases/options/option_message1.proto
...
LOOP_SCAN:
	for { // Loop to read the JSON objects
		...
		default:
			return jsondecoder.ErrUnknownField(dec)
		} // end switch
	}
	return nil
}

// MarshalJSON implements interface json.Marshaler for proto message DisallowUnknownMessage2 in file tests/proto/cases/options/option_message1.proto
