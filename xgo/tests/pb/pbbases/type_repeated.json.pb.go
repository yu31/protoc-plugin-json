...
func (x *MessageRepeated1) UnmarshalJSON(b []byte) error {
	if x == nil {
		return errors.New("json: Unmarshal: xgo/tests/pb/pbbases.(*MessageRepeated1) is nil")
	}
	var (
		err     error
		isNULL  bool
...
func (x *MessageRepeated1_Embed1) UnmarshalJSON(b []byte) error {
	if x == nil {
		return errors.New("json: Unmarshal: xgo/tests/pb/pbbases.(*MessageRepeated1_Embed1) is nil")
	}
	var (
		err     error
		isNULL  bool
...
func (x *MessageRepeated1_Embed1_Embed2) UnmarshalJSON(b []byte) error {
	if x == nil {
		return errors.New("json: Unmarshal: xgo/tests/pb/pbbases.(*MessageRepeated1_Embed1_Embed2) is nil")
	}
	var (
		err     error
		isNULL  bool
...
func (x *TypeRepeated1) UnmarshalJSON(b []byte) error {
	if x == nil {
		return errors.New("json: Unmarshal: xgo/tests/pb/pbbases.(*TypeRepeated1) is nil")
	}
	var (
		err     error
		isNULL  bool
