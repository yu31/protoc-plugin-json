...
func (x *MessageCommon1) UnmarshalJSON(b []byte) error {
	if x == nil {
		return errors.New("json: Unmarshal: xgo/tests/pb/pbbases.(*MessageCommon1) is nil")
	}
	var (
		err    error
		isNULL bool
...
func (x *MessageCommon1_Embed1) UnmarshalJSON(b []byte) error {
	if x == nil {
		return errors.New("json: Unmarshal: xgo/tests/pb/pbbases.(*MessageCommon1_Embed1) is nil")
	}
	var (
		err    error
		isNULL bool
...
func (x *MessageCommon1_Embed1_Embed2) UnmarshalJSON(b []byte) error {
	if x == nil {
		return errors.New("json: Unmarshal: xgo/tests/pb/pbbases.(*MessageCommon1_Embed1_Embed2) is nil")
	}
	var (
		err    error
		isNULL bool
