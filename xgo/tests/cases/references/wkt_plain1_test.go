...
var seedWKTPlain1 = &pbreferences.WKTPlain1{
	FEnumNumber1:                2,
	FEnumNumberString1:          7,
	FEnumString1:                5,
...
func Test_Reference_WKT_Plain1_General(t *testing.T) {
	bb, err := seedWKTPlain1.MarshalJSON()
	require.Nil(t, err)

	fmt.Println(string(bb))

	dataNew := &pbreferences.WKTPlain1{}
	err = dataNew.UnmarshalJSON(bb)
	require.Nil(t, err)

	require.Equal(t, seedWKTPlain1, dataNew)
}

func Test_Reference_WKT_Plain1_Check(t *testing.T) {
	bb, err := seedWKTPlain1.MarshalJSON()
	require.Nil(t, err)
