...
var seedWKTOneOf1 = &pbformat.WKTOneOf1{
	OneEnum1: &pbformat.WKTOneOf1_FEnumNumber1{FEnumNumber1: 2},
	OneEnum2: &pbformat.WKTOneOf1_FEnumNumberString1{FEnumNumberString1: 2},
	OneAny1: &pbformat.WKTOneOf1_FAnyNative1{
		FAnyNative1: utils.MustNewAny(&pbformat.Message1{FString1: "s101", FString2: "s102", FString3: "s103"}),
	},
	OneDuration1: &pbformat.WKTOneOf1_FDurationNative1{
		FDurationNative1: &durationpb.Duration{Seconds: 111, Nanos: 0},
	},
	OneDuration2: &pbformat.WKTOneOf1_FDurationNanosecond1{
		FDurationNanosecond1: &durationpb.Duration{Seconds: 113, Nanos: 0},
	},
	OneDuration3: &pbformat.WKTOneOf1_FDurationMillisecond1{
		FDurationMillisecond1: &durationpb.Duration{Seconds: 115, Nanos: 0},
	},
	OneDuration4: &pbformat.WKTOneOf1_FDurationMinute1{
		FDurationMinute1: &durationpb.Duration{Seconds: 117, Nanos: 0},
	},
	OneDuration5: &pbformat.WKTOneOf1_FDurationNanosecondString1{
		FDurationNanosecondString1: &durationpb.Duration{Seconds: 113, Nanos: 0},
	},
	OneDuration6: &pbformat.WKTOneOf1_FDurationMillisecondString1{
		FDurationMillisecondString1: &durationpb.Duration{Seconds: 115, Nanos: 0},
	},
	OneDuration7: &pbformat.WKTOneOf1_FDurationMinuteString1{
		FDurationMinuteString1: &durationpb.Duration{Seconds: 117, Nanos: 0},
	},
	OneTimestamp1: &pbformat.WKTOneOf1_FTimestampNative1{
		FTimestampNative1: &timestamppb.Timestamp{Seconds: 1686416585, Nanos: 0},
	},
	OneTimestamp2: &pbformat.WKTOneOf1_FTimestampUnixNano1{
		FTimestampUnixNano1: &timestamppb.Timestamp{Seconds: 1686416585, Nanos: 0},
	},
	OneTimestamp3: &pbformat.WKTOneOf1_FTimestampUnixMilli1{
		FTimestampUnixMilli1: &timestamppb.Timestamp{Seconds: 1686416585, Nanos: 0},
	},
	OneTimestamp4: &pbformat.WKTOneOf1_FTimestampUnixNanoString1{
		FTimestampUnixNanoString1: &timestamppb.Timestamp{Seconds: 1686416585, Nanos: 0},
	},
	OneTimestamp5: &pbformat.WKTOneOf1_FTimestampUnixMilliString1{
		FTimestampUnixMilliString1: &timestamppb.Timestamp{Seconds: 1686416585, Nanos: 0},
	},
}

// timestamp: 1686416585 -> 2023-06-11 01:03:05
var seedWKTOneOf2 = &pbformat.WKTOneOf1{
	OneEnum1: &pbformat.WKTOneOf1_FEnumString1{FEnumString1: 5},
	OneEnum2: &pbformat.WKTOneOf1_FEnumNumberString2{FEnumNumberString2: 5},
	OneAny1: &pbformat.WKTOneOf1_FAnyProto1{
		FAnyProto1: utils.MustNewAny(&pbformat.Message1{FString1: "s301", FString2: "s302", FString3: "s303"}),
	},
	OneDuration1: &pbformat.WKTOneOf1_FDurationString1{
		FDurationString1: &durationpb.Duration{Seconds: 112, Nanos: 0},
	},
	OneDuration2: &pbformat.WKTOneOf1_FDurationMicrosecond1{
		FDurationMicrosecond1: &durationpb.Duration{Seconds: 114, Nanos: 0},
	},
	OneDuration3: &pbformat.WKTOneOf1_FDurationSecond1{
		FDurationSecond1: &durationpb.Duration{Seconds: 116, Nanos: 0},
	},
	OneDuration4: &pbformat.WKTOneOf1_FDurationHour1{
		FDurationHour1: &durationpb.Duration{Seconds: 7200, Nanos: 0},
	},
	OneDuration5: &pbformat.WKTOneOf1_FDurationMicrosecondString1{
		FDurationMicrosecondString1: &durationpb.Duration{Seconds: 114, Nanos: 0},
	},
	OneDuration6: &pbformat.WKTOneOf1_FDurationSecondString1{
		FDurationSecondString1: &durationpb.Duration{Seconds: 116, Nanos: 0},
	},
	OneDuration7: &pbformat.WKTOneOf1_FDurationHourString1{
		FDurationHourString1: &durationpb.Duration{Seconds: 7200, Nanos: 0},
	},
	OneTimestamp1: &pbformat.WKTOneOf1_FTimestampTimeLayout1{
		FTimestampTimeLayout1: &timestamppb.Timestamp{Seconds: 1686416585, Nanos: 0},
	},
	OneTimestamp2: &pbformat.WKTOneOf1_FTimestampUnixMicro1{
		FTimestampUnixMicro1: &timestamppb.Timestamp{Seconds: 1686416585, Nanos: 0},
	},
	OneTimestamp3: &pbformat.WKTOneOf1_FTimestampUnixSec1{
		FTimestampUnixSec1: &timestamppb.Timestamp{Seconds: 1686416585, Nanos: 0},
	},
	OneTimestamp4: &pbformat.WKTOneOf1_FTimestampUnixMicroString1{
		FTimestampUnixMicroString1: &timestamppb.Timestamp{Seconds: 1686416585, Nanos: 0},
	},
	OneTimestamp5: &pbformat.WKTOneOf1_FTimestampUnixSecString1{
