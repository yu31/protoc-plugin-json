...
var seedWKTRepeated1 = &pbformat.WKTRepeated1{
	FEnumNumber1:       []pbformat.Enum1{0, 2, 6},
	FEnumNumberString1: []pbformat.Enum1{0, 2, 6},
	FEnumString1:       []pbformat.Enum1{3, 5, 7},
	FAnyNative1: []*any.Any{
		utils.MustNewAny(&pbformat.Message1{FString1: "s111", FString2: "s112", FString3: "s113"}),
		utils.MustNewAny(&pbformat.Message1{FString1: "s121", FString2: "s122", FString3: "s123"}),
		utils.MustNewAny(&pbformat.Message1{FString1: "s131", FString2: "s132", FString3: "s133"}),
	},
	FAnyProto1: []*any.Any{
		utils.MustNewAny(&pbformat.Message1{FString1: "s311", FString2: "s312", FString3: "s313"}),
		utils.MustNewAny(&pbformat.Message1{FString1: "s321", FString2: "s322", FString3: "s323"}),
		utils.MustNewAny(&pbformat.Message1{FString1: "s331", FString2: "s332", FString3: "s333"}),
	},
