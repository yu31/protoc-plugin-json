...
var seedWKTMap1 = &pbformat.WKTMap1{
	FEnumNumber1: map[string]pbformat.Enum1{
		"ke11": 0, "ke12": 2, "ke13": 6,
	},
	FEnumNumberString1: map[string]pbformat.Enum1{
		"ke11": 0, "ke12": 2, "ke13": 6,
	},
	FEnumString1: map[string]pbformat.Enum1{
		"ke21": 3, "ke22": 5, "ke23": 7,
	},
	FAnyNative1: map[string]*any.Any{
		"ka11": utils.MustNewAny(&pbformat.Message1{FString1: "s111", FString2: "s112", FString3: "s113"}),
		"ka12": utils.MustNewAny(&pbformat.Message1{FString1: "s121", FString2: "s122", FString3: "s123"}),
		"ka13": utils.MustNewAny(&pbformat.Message1{FString1: "s131", FString2: "s132", FString3: "s133"}),
	},
	FAnyProto1: map[string]*any.Any{
		"ka21": utils.MustNewAny(&pbformat.Message1{FString1: "s311", FString2: "s312", FString3: "s313"}),
		"ka22": utils.MustNewAny(&pbformat.Message1{FString1: "s321", FString2: "s322", FString3: "s323"}),
		"ka23": utils.MustNewAny(&pbformat.Message1{FString1: "s331", FString2: "s332", FString3: "s333"}),
	},
