...
type CopyOptional1 pbbases.TypeOptional1

var seedOptional1 = &pbbases.TypeOptional1{
	...
	FBytes1:     []byte("bytes1"),
	FEnum1:      pbbases.EnumOptional1(2).Enum(),
	FEnum2:      pbexternal.Enum1(3).Enum(),
	FEnum3:      pbexternal.Embed_Enum1(5).Enum(),
	FEnum4:      pbexternal.Embed_Message_Enum1(6).Enum(),
	FEnum5:      pbbases.EnumCommon1(7).Enum(),
	FEnum6:      pbbases.MessageCommon1_Enum1(9).Enum(),
	...
	FAny2:       utils.MustNewAny(&pbbases.MessageOptional1{FString1: "any21", FString2: "any22", FString3: "any23"}),
	FMessage1:   &pbbases.MessageOptional1{FString1: "1101", FString2: "1102", FString3: "1103"},
	FMessage2:   &pbbases.MessageOptional1_Embed1{FString1: "1201", FString2: "1202", FString3: "1203"},
	FMessage3:   &pbbases.MessageOptional1_Embed1_Embed2{FString1: "1301", FString2: "1302", FString3: "1303"},
	...
	FMessage7:   &pbbases.MessageCommon1{FString1: "1701", FString2: "1702", FString3: "1703"},
	FMessage8:   &pbbases.MessageCommon1_Embed1{FString1: "1801", FString2: "1802", FString3: "1803"},
	FMessage9:   &pbbases.MessageCommon1_Embed1_Embed2{FString1: "1901", FString2: "1902", FString3: "1903"},
}

func Test_TypeOptional1_Assert_Type(t *testing.T) {
	data := &pbbases.TypeOptional1{}
...
func Test_TypeOptional1_Empty(t *testing.T) {
	dataEmtpy := &pbbases.TypeOptional1{}
	dataCopy := &CopyOptional1{}
