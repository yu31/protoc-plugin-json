...
type CopyMap1 pbbases.TypeMap1

var seedMap1 = &pbbases.TypeMap1{
	...
	FEnum1:      map[string]pbbases.EnumMap1{"ke11": 2},
	...
	FEnum5:      map[string]pbbases.EnumCommon1{"ke51": 7},
	FEnum6:      map[string]pbbases.MessageCommon1_Enum1{"ke61": 9},
	...
	FAny2: map[string]*anypb.Any{
		"ka13": utils.MustNewAny(&pbbases.MessageCommon1{FString1: "any11", FString2: "any12", FString3: "any13"}),
	},
	FMessage1: map[string]*pbbases.MessageMap1{
		"km11": {FString1: "1101", FString2: "1102", FString3: "1103"},
	},
	FMessage2: map[string]*pbbases.MessageMap1_Embed1{
		"km21": {FString1: "1201", FString2: "1202", FString3: "1203"},
	},
	FMessage3: map[string]*pbbases.MessageMap1_Embed1_Embed2{
