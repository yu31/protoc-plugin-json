...
type CopyOptional1 pbtypes.TypeOptional1

var seedOptional1 = &pbtypes.TypeOptional1{
	...
	FBytes1:     []byte("bytes1"),
	FEnum1:      pbtypes.EnumOptional1(2).Enum(),
	FEnum2:      pbexternal.Enum1(3).Enum(),
	FEnum3:      pbexternal.Embed_Enum1(5).Enum(),
	FEnum4:      pbexternal.Embed_Message_Enum1(6).Enum(),
	FEnum5:      pbtypes.EnumCommon1(7).Enum(),
	FEnum6:      pbtypes.MessageCommon1_Enum1(9).Enum(),
	...
	FAny2:       utils.MustNewAny(&pbtypes.MessageOptional1{FString1: "any21", FString2: "any22", FString3: "any23"}),
	FMessage1:   &pbtypes.MessageOptional1{FString1: "1101", FString2: "1102", FString3: "1103"},
	FMessage2:   &pbtypes.MessageOptional1_Embed1{FString1: "1201", FString2: "1202", FString3: "1203"},
	FMessage3:   &pbtypes.MessageOptional1_Embed1_Embed2{FString1: "1301", FString2: "1302", FString3: "1303"},
...
func Test_TypeOptional1_Empty(t *testing.T) {
	dataEmtpy := &pbtypes.TypeOptional1{}
	dataCopy := &CopyOptional1{}
