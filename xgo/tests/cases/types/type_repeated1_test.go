...
type CopyRepeated1 pbtypes.TypeRepeated1

var seedRepeated1 = &pbtypes.TypeRepeated1{
	...
	FEnum1:    []pbtypes.EnumRepeated1{2, 3, 5},
	FEnum2:    []pbexternal.Enum1{6, 7, 9},
	FEnum3:    []pbexternal.Embed_Enum1{2, 3, 5},
	FEnum4:    []pbexternal.Embed_Message_Enum1{6, 7, 9},
	FEnum5:    []pbtypes.EnumCommon1{2, 3, 5},
	FEnum6:    []pbtypes.MessageCommon1_Enum1{6, 7, 9},
	...
	FAny1: []*anypb.Any{
		...
		utils.MustNewAny(&pbtypes.MessageRepeated1{FString1: "any21", FString2: "any22", FString3: "any23"}),
	},
	FAny2: []*anypb.Any{
		utils.MustNewAny(&pbtypes.MessageCommon1{FString1: "any11", FString2: "any12", FString3: "any13"}),
	},
...
func Test_TypeRepeated1_Empty(t *testing.T) {
	dataEmtpy := &pbtypes.TypeRepeated1{}
	dataCopy := &CopyRepeated1{}
