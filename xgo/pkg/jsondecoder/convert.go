...
func unquoteBytes(b []byte) (t []byte, err error) {
	var ok bool
...
func unquoteString(b []byte) (t []byte, err error) {
	var ok bool
	if t, ok = unquoteStdBytes(b); !ok {
...
func convertToBytes(b []byte) (vv []byte, err error) {
	if b, err = unquoteBytes(b); err != nil {
		return
	}
...
func convertToString(b []byte) (vv string, err error) {
...
func convertToBool(unquote bool, b []byte) (vv bool, err error) {
	if unquote {
		if b, err = unquoteString(b); err != nil {
			return
		}
	}
...
func convertToInt32(unquote bool, b []byte) (vv int32, err error) {
	if unquote {
		if b, err = unquoteString(b); err != nil {
			return
		}
...
func convertToInt64(unquote bool, b []byte) (vv int64, err error) {
	if unquote {
		if b, err = unquoteString(b); err != nil {
			return
		}
...
func convertToUint32(unquote bool, b []byte) (vv uint32, err error) {
	if unquote {
		if b, err = unquoteString(b); err != nil {
			return
		}
...
func convertToUint64(unquote bool, b []byte) (vv uint64, err error) {
	if unquote {
		if b, err = unquoteString(b); err != nil {
			return
		}
...
func convertToFloat32(unquote bool, b []byte) (vv float32, err error) {
...
func convertToFloat64(unquote bool, b []byte) (vv float64, err error) {
	if unquote && floatIsNumber(b) {
		if b, err = unquoteString(b); err != nil {
			return
		}
...
func convertToEnum(unquote bool, b []byte) (vv int32, err error) {
	if unquote {
		if b, err = unquoteString(b); err != nil {
			return
		}
