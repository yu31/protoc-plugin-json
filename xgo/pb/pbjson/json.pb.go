...
const (
	...
	TypeInt32_Numeric TypeInt32_Codec = 1
...
const (
	...
	// Numeric represents convert the field as numeric when encoding and decoding JSON.
	TypeInt64_Numeric TypeInt64_Codec = 1
	// String represents convert the field as strings when encoding and decoding JSON.
...
func (TypeInt64_Codec) EnumDescriptor() ([]byte, []int) {
	return file_json_proto_rawDescGZIP(), []int{7, 0}
}
...
const (
	...
	// Numeric represents convert the field as numeric when encoding and decoding JSON.
	TypeSInt32_Numeric TypeSInt32_Codec = 1
	// String represents convert the field as strings when encoding and decoding JSON.
...
const (
	...
	// Numeric represents convert the field as numeric when encoding and decoding JSON.
	TypeSInt64_Numeric TypeSInt64_Codec = 1
	// String represents convert the field as strings when encoding and decoding JSON.
...
const (
	...
	// Numeric represents convert the field as numeric when encoding and decoding JSON.
	TypeSFixed32_Numeric TypeSFixed32_Codec = 1
	// String represents convert the field as strings when encoding and decoding JSON.
...
const (
	...
	// Numeric represents convert the field as numeric when encoding and decoding JSON.
	TypeSFixed64_Numeric TypeSFixed64_Codec = 1
	// String represents convert the field as strings when encoding and decoding JSON.
...
const (
	...
	// Numeric represents convert the field as numeric when encoding and decoding JSON.
	TypeUint32_Numeric TypeUint32_Codec = 1
	// String represents convert the field as strings when encoding and decoding JSON.
...
const (
	...
	// Numeric represents convert the field as numeric when encoding and decoding JSON.
	TypeUint64_Numeric TypeUint64_Codec = 1
	// String represents convert the field as strings when encoding and decoding JSON.
...
const (
	...
	// Numeric represents convert the field as numeric when encoding and decoding JSON.
	TypeFixed32_Numeric TypeFixed32_Codec = 1
	// String represents convert the field as strings when encoding and decoding JSON.
...
const (
	...
	// Numeric represents convert the field as numeric when encoding and decoding JSON.
	TypeFixed64_Numeric TypeFixed64_Codec = 1
	// String represents convert the field as strings when encoding and decoding JSON.
...
const (
	...
	// Numeric represents convert the field as numeric when encoding and decoding JSON.
	TypeFloat_Numeric TypeFloat_Codec = 1
	// String represents convert the field as strings when encoding and decoding JSON.
...
const (
	...
	// Numeric represents convert the field as numeric when encoding and decoding JSON.
	TypeDouble_Numeric TypeDouble_Codec = 1
	// String represents convert the field as strings when encoding and decoding JSON.
...
type FieldOptions struct {
	...
	Format *TypeFormat `protobuf:"bytes,11,opt,name=format,proto3" json:"format,omitempty"`
}
...
func (x *FieldOptions) GetFormat() *TypeFormat {
	if x != nil {
		return x.Format
	}
	return nil
...
type TypeFormat struct {
	...
	//	*TypeFormat_Any
	//	*TypeFormat_Duration
	//	*TypeFormat_Timestamp
	//	*TypeFormat_Repeated
	//	*TypeFormat_Map
	Kind isTypeFormat_Kind `protobuf_oneof:"Kind"`
}

func (x *TypeFormat) Reset() {
	*x = TypeFormat{}
	if protoimpl.UnsafeEnabled {
...
func (x *TypeFormat) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TypeFormat) ProtoMessage() {}

func (x *TypeFormat) ProtoReflect() protoreflect.Message {
	mi := &file_json_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TypeFormat.ProtoReflect.Descriptor instead.
func (*TypeFormat) Descriptor() ([]byte, []int) {
	return file_json_proto_rawDescGZIP(), []int{3}
}

func (m *TypeFormat) GetKind() isTypeFormat_Kind {
	if m != nil {
		return m.Kind
	}
	return nil
...
func (x *TypeFormat) GetInt32() *TypeInt32 {
	if x, ok := x.GetKind().(*TypeFormat_Int32); ok {
		return x.Int32
	}
	return nil
}

func (x *TypeFormat) GetInt64() *TypeInt64 {
	if x, ok := x.GetKind().(*TypeFormat_Int64); ok {
		return x.Int64
	}
	return nil
}

func (x *TypeFormat) GetSint32() *TypeSInt32 {
	if x, ok := x.GetKind().(*TypeFormat_Sint32); ok {
		return x.Sint32
	}
	return nil
}

func (x *TypeFormat) GetSint64() *TypeSInt64 {
	if x, ok := x.GetKind().(*TypeFormat_Sint64); ok {
		return x.Sint64
	}
	return nil
}

func (x *TypeFormat) GetSfixed32() *TypeSFixed32 {
	if x, ok := x.GetKind().(*TypeFormat_Sfixed32); ok {
		return x.Sfixed32
	}
	return nil
}

func (x *TypeFormat) GetSfixed64() *TypeSFixed64 {
	if x, ok := x.GetKind().(*TypeFormat_Sfixed64); ok {
		return x.Sfixed64
	}
	return nil
}

func (x *TypeFormat) GetUint32() *TypeUint32 {
	if x, ok := x.GetKind().(*TypeFormat_Uint32); ok {
		return x.Uint32
	}
	return nil
}

func (x *TypeFormat) GetUint64() *TypeUint64 {
	if x, ok := x.GetKind().(*TypeFormat_Uint64); ok {
		return x.Uint64
	}
	return nil
}

func (x *TypeFormat) GetFixed32() *TypeFixed32 {
	if x, ok := x.GetKind().(*TypeFormat_Fixed32); ok {
		return x.Fixed32
	}
	return nil
}

func (x *TypeFormat) GetFixed64() *TypeFixed64 {
	if x, ok := x.GetKind().(*TypeFormat_Fixed64); ok {
		return x.Fixed64
	}
	return nil
}

func (x *TypeFormat) GetFloat() *TypeFloat {
	if x, ok := x.GetKind().(*TypeFormat_Float); ok {
		return x.Float
	}
	return nil
}

func (x *TypeFormat) GetDouble() *TypeDouble {
	if x, ok := x.GetKind().(*TypeFormat_Double); ok {
		return x.Double
	}
	return nil
}

func (x *TypeFormat) GetBool() *TypeBool {
	if x, ok := x.GetKind().(*TypeFormat_Bool); ok {
		return x.Bool
	}
	return nil
}

func (x *TypeFormat) GetEnum() *TypeEnum {
	if x, ok := x.GetKind().(*TypeFormat_Enum); ok {
		return x.Enum
	}
	return nil
}

func (x *TypeFormat) GetString_() *TypeString {
	if x, ok := x.GetKind().(*TypeFormat_String_); ok {
		return x.String_
	}
	return nil
}

func (x *TypeFormat) GetBytes() *TypeBytes {
	if x, ok := x.GetKind().(*TypeFormat_Bytes); ok {
		return x.Bytes
	}
	return nil
}

func (x *TypeFormat) GetMessage() *TypeMessage {
	if x, ok := x.GetKind().(*TypeFormat_Message); ok {
		return x.Message
	}
	return nil
}

func (x *TypeFormat) GetAny() *TypeAny {
	if x, ok := x.GetKind().(*TypeFormat_Any); ok {
		return x.Any
	}
	return nil
}

func (x *TypeFormat) GetDuration() *TypeDuration {
	if x, ok := x.GetKind().(*TypeFormat_Duration); ok {
		return x.Duration
	}
	return nil
}

func (x *TypeFormat) GetTimestamp() *TypeTimestamp {
	if x, ok := x.GetKind().(*TypeFormat_Timestamp); ok {
		return x.Timestamp
	}
	return nil
}

func (x *TypeFormat) GetRepeated() *TypeRepeated {
	if x, ok := x.GetKind().(*TypeFormat_Repeated); ok {
		return x.Repeated
	}
	return nil
}

func (x *TypeFormat) GetMap() *TypeMap {
	if x, ok := x.GetKind().(*TypeFormat_Map); ok {
		return x.Map
	}
	return nil
}

type isTypeFormat_Kind interface {
	isTypeFormat_Kind()
}

type TypeFormat_Int32 struct {
	Int32 *TypeInt32 `protobuf:"bytes,1,opt,name=int32,proto3,oneof"`
}

type TypeFormat_Int64 struct {
	Int64 *TypeInt64 `protobuf:"bytes,2,opt,name=int64,proto3,oneof"`
}

type TypeFormat_Sint32 struct {
	Sint32 *TypeSInt32 `protobuf:"bytes,3,opt,name=sint32,proto3,oneof"`
}

type TypeFormat_Sint64 struct {
	Sint64 *TypeSInt64 `protobuf:"bytes,4,opt,name=sint64,proto3,oneof"`
}

type TypeFormat_Sfixed32 struct {
	Sfixed32 *TypeSFixed32 `protobuf:"bytes,5,opt,name=sfixed32,proto3,oneof"`
}

type TypeFormat_Sfixed64 struct {
	Sfixed64 *TypeSFixed64 `protobuf:"bytes,6,opt,name=sfixed64,proto3,oneof"`
}

type TypeFormat_Uint32 struct {
	Uint32 *TypeUint32 `protobuf:"bytes,7,opt,name=uint32,proto3,oneof"`
}

type TypeFormat_Uint64 struct {
	Uint64 *TypeUint64 `protobuf:"bytes,8,opt,name=uint64,proto3,oneof"`
}

type TypeFormat_Fixed32 struct {
	Fixed32 *TypeFixed32 `protobuf:"bytes,9,opt,name=fixed32,proto3,oneof"`
}

type TypeFormat_Fixed64 struct {
	Fixed64 *TypeFixed64 `protobuf:"bytes,10,opt,name=fixed64,proto3,oneof"`
}

type TypeFormat_Float struct {
	Float *TypeFloat `protobuf:"bytes,11,opt,name=float,proto3,oneof"`
}

type TypeFormat_Double struct {
	Double *TypeDouble `protobuf:"bytes,12,opt,name=double,proto3,oneof"`
}

type TypeFormat_Bool struct {
	Bool *TypeBool `protobuf:"bytes,13,opt,name=bool,proto3,oneof"`
}

type TypeFormat_Enum struct {
	Enum *TypeEnum `protobuf:"bytes,14,opt,name=enum,proto3,oneof"`
}

type TypeFormat_String_ struct {
	String_ *TypeString `protobuf:"bytes,15,opt,name=string,proto3,oneof"` // Reserved.
}

type TypeFormat_Bytes struct {
	Bytes *TypeBytes `protobuf:"bytes,16,opt,name=bytes,proto3,oneof"` // Reserved.
}

type TypeFormat_Message struct {
	Message *TypeMessage `protobuf:"bytes,17,opt,name=message,proto3,oneof"` // Reserved.
}

type TypeFormat_Any struct {
	Any *TypeAny `protobuf:"bytes,21,opt,name=any,proto3,oneof"`
}

type TypeFormat_Duration struct {
	Duration *TypeDuration `protobuf:"bytes,22,opt,name=duration,proto3,oneof"`
}

type TypeFormat_Timestamp struct {
	Timestamp *TypeTimestamp `protobuf:"bytes,23,opt,name=timestamp,proto3,oneof"`
}

type TypeFormat_Repeated struct {
	Repeated *TypeRepeated `protobuf:"bytes,31,opt,name=repeated,proto3,oneof"`
}

type TypeFormat_Map struct {
	Map *TypeMap `protobuf:"bytes,32,opt,name=map,proto3,oneof"`
}

func (*TypeFormat_Int32) isTypeFormat_Kind() {}

func (*TypeFormat_Int64) isTypeFormat_Kind() {}

func (*TypeFormat_Sint32) isTypeFormat_Kind() {}

func (*TypeFormat_Sint64) isTypeFormat_Kind() {}

func (*TypeFormat_Sfixed32) isTypeFormat_Kind() {}

func (*TypeFormat_Sfixed64) isTypeFormat_Kind() {}

func (*TypeFormat_Uint32) isTypeFormat_Kind() {}

func (*TypeFormat_Uint64) isTypeFormat_Kind() {}

func (*TypeFormat_Fixed32) isTypeFormat_Kind() {}

func (*TypeFormat_Fixed64) isTypeFormat_Kind() {}

func (*TypeFormat_Float) isTypeFormat_Kind() {}

func (*TypeFormat_Double) isTypeFormat_Kind() {}

func (*TypeFormat_Bool) isTypeFormat_Kind() {}

func (*TypeFormat_Enum) isTypeFormat_Kind() {}

func (*TypeFormat_String_) isTypeFormat_Kind() {}

func (*TypeFormat_Bytes) isTypeFormat_Kind() {}

func (*TypeFormat_Message) isTypeFormat_Kind() {}

func (*TypeFormat_Any) isTypeFormat_Kind() {}

func (*TypeFormat_Duration) isTypeFormat_Kind() {}

func (*TypeFormat_Timestamp) isTypeFormat_Kind() {}

func (*TypeFormat_Repeated) isTypeFormat_Kind() {}

func (*TypeFormat_Map) isTypeFormat_Kind() {}
...
type TypeRepeated struct {
	...
	Elem *TypeFormat `protobuf:"bytes,1,opt,name=elem,proto3" json:"elem,omitempty"`
}

func (x *TypeRepeated) Reset() {
	*x = TypeRepeated{}
	if protoimpl.UnsafeEnabled {
...
func (x *TypeRepeated) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TypeRepeated) ProtoMessage() {}

func (x *TypeRepeated) ProtoReflect() protoreflect.Message {
	mi := &file_json_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TypeRepeated.ProtoReflect.Descriptor instead.
func (*TypeRepeated) Descriptor() ([]byte, []int) {
	return file_json_proto_rawDescGZIP(), []int{4}
}

func (x *TypeRepeated) GetElem() *TypeFormat {
	if x != nil {
		return x.Elem
	}
	return nil
...
type TypeMap struct {
	...
	Key *TypeFormat `protobuf:"bytes,1,opt,name=key,proto3" json:"key,omitempty"`
	// Value reports the codec of map value.
	Value *TypeFormat `protobuf:"bytes,2,opt,name=value,proto3" json:"value,omitempty"`
}
...
func (x *TypeMap) GetKey() *TypeFormat {
	if x != nil {
		return x.Key
	}
	return nil
...
func (x *TypeMap) GetValue() *TypeFormat {
	if x != nil {
		return x.Value
	}
	return nil
...
var file_json_proto_rawDesc = []byte{
	...
	0x5f, 0x69, 0x6e, 0x6c, 0x69, 0x6e, 0x65, 0x22, 0xb8, 0x01, 0x0a, 0x0c, 0x46, 0x69, 0x65, 0x6c,
	...
	0x65, 0x88, 0x01, 0x01, 0x12, 0x28, 0x0a, 0x06, 0x66, 0x6f, 0x72, 0x6d, 0x61, 0x74, 0x18, 0x0b,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x6a, 0x73, 0x6f, 0x6e, 0x2e, 0x54, 0x79, 0x70, 0x65,
	0x46, 0x6f, 0x72, 0x6d, 0x61, 0x74, 0x52, 0x06, 0x66, 0x6f, 0x72, 0x6d, 0x61, 0x74, 0x42, 0x07,
	0x0a, 0x05, 0x5f, 0x6a, 0x73, 0x6f, 0x6e, 0x42, 0x09, 0x0a, 0x07, 0x5f, 0x69, 0x6e, 0x6c, 0x69,
	0x6e, 0x65, 0x22, 0xdc, 0x07, 0x0a, 0x0a, 0x54, 0x79, 0x70, 0x65, 0x46, 0x6f, 0x72, 0x6d, 0x61,
	0x74, 0x12, 0x27, 0x0a, 0x05, 0x69, 0x6e, 0x74, 0x33, 0x32, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b,
	...
	,
	...
	,
	...
	,
	...
	,
...
var file_json_proto_msgTypes = make([]protoimpl.MessageInfo, 27)
var file_json_proto_goTypes = []interface{}{
	...
	(*TypeFormat)(nil),                  // 20: json.TypeFormat
	(*TypeRepeated)(nil),                // 21: json.TypeRepeated
	(*TypeMap)(nil),                     // 22: json.TypeMap
	(*TypeInt32)(nil),                   // 23: json.TypeInt32
	(*TypeInt64)(nil),                   // 24: json.TypeInt64
	(*TypeSInt32)(nil),                  // 25: json.TypeSInt32
	(*TypeSInt64)(nil),                  // 26: json.TypeSInt64
	(*TypeSFixed32)(nil),                // 27: json.TypeSFixed32
	(*TypeSFixed64)(nil),                // 28: json.TypeSFixed64
	(*TypeUint32)(nil),                  // 29: json.TypeUint32
	(*TypeUint64)(nil),                  // 30: json.TypeUint64
	(*TypeFixed32)(nil),                 // 31: json.TypeFixed32
	(*TypeFixed64)(nil),                 // 32: json.TypeFixed64
	(*TypeFloat)(nil),                   // 33: json.TypeFloat
	(*TypeDouble)(nil),                  // 34: json.TypeDouble
	(*TypeBool)(nil),                    // 35: json.TypeBool
	(*TypeString)(nil),                  // 36: json.TypeString
	(*TypeBytes)(nil),                   // 37: json.TypeBytes
	(*TypeMessage)(nil),                 // 38: json.TypeMessage
	(*TypeEnum)(nil),                    // 39: json.TypeEnum
	(*TypeAny)(nil),                     // 40: json.TypeAny
	(*TypeDuration)(nil),                // 41: json.TypeDuration
	(*TypeTimestamp)(nil),               // 42: json.TypeTimestamp
	(*TypeTimestamp_Layout)(nil),        // 43: json.TypeTimestamp.Layout
	...
	(*descriptorpb.OneofOptions)(nil),   // 46: google.protobuf.OneofOptions
}
var file_json_proto_depIdxs = []int32{
	20, // 0: json.FieldOptions.format:type_name -> json.TypeFormat
	23, // 1: json.TypeFormat.int32:type_name -> json.TypeInt32
	24, // 2: json.TypeFormat.int64:type_name -> json.TypeInt64
	25, // 3: json.TypeFormat.sint32:type_name -> json.TypeSInt32
	26, // 4: json.TypeFormat.sint64:type_name -> json.TypeSInt64
	27, // 5: json.TypeFormat.sfixed32:type_name -> json.TypeSFixed32
	28, // 6: json.TypeFormat.sfixed64:type_name -> json.TypeSFixed64
	29, // 7: json.TypeFormat.uint32:type_name -> json.TypeUint32
	30, // 8: json.TypeFormat.uint64:type_name -> json.TypeUint64
	31, // 9: json.TypeFormat.fixed32:type_name -> json.TypeFixed32
	32, // 10: json.TypeFormat.fixed64:type_name -> json.TypeFixed64
	33, // 11: json.TypeFormat.float:type_name -> json.TypeFloat
	34, // 12: json.TypeFormat.double:type_name -> json.TypeDouble
	35, // 13: json.TypeFormat.bool:type_name -> json.TypeBool
	39, // 14: json.TypeFormat.enum:type_name -> json.TypeEnum
	36, // 15: json.TypeFormat.string:type_name -> json.TypeString
	37, // 16: json.TypeFormat.bytes:type_name -> json.TypeBytes
	38, // 17: json.TypeFormat.message:type_name -> json.TypeMessage
	40, // 18: json.TypeFormat.any:type_name -> json.TypeAny
	41, // 19: json.TypeFormat.duration:type_name -> json.TypeDuration
	42, // 20: json.TypeFormat.timestamp:type_name -> json.TypeTimestamp
	21, // 21: json.TypeFormat.repeated:type_name -> json.TypeRepeated
	22, // 22: json.TypeFormat.map:type_name -> json.TypeMap
	20, // 23: json.TypeRepeated.elem:type_name -> json.TypeFormat
	20, // 24: json.TypeMap.key:type_name -> json.TypeFormat
	20, // 25: json.TypeMap.value:type_name -> json.TypeFormat
	0,  // 26: json.TypeInt32.codec:type_name -> json.TypeInt32.Codec
	1,  // 27: json.TypeInt64.codec:type_name -> json.TypeInt64.Codec
	2,  // 28: json.TypeSInt32.codec:type_name -> json.TypeSInt32.Codec
	3,  // 29: json.TypeSInt64.codec:type_name -> json.TypeSInt64.Codec
	4,  // 30: json.TypeSFixed32.codec:type_name -> json.TypeSFixed32.Codec
	5,  // 31: json.TypeSFixed64.codec:type_name -> json.TypeSFixed64.Codec
	6,  // 32: json.TypeUint32.codec:type_name -> json.TypeUint32.Codec
	7,  // 33: json.TypeUint64.codec:type_name -> json.TypeUint64.Codec
	8,  // 34: json.TypeFixed32.codec:type_name -> json.TypeFixed32.Codec
	9,  // 35: json.TypeFixed64.codec:type_name -> json.TypeFixed64.Codec
	10, // 36: json.TypeFloat.codec:type_name -> json.TypeFloat.Codec
	11, // 37: json.TypeDouble.codec:type_name -> json.TypeDouble.Codec
	12, // 38: json.TypeBool.codec:type_name -> json.TypeBool.Codec
	13, // 39: json.TypeEnum.codec:type_name -> json.TypeEnum.Codec
	14, // 40: json.TypeAny.codec:type_name -> json.TypeAny.Codec
	15, // 41: json.TypeDuration.codec:type_name -> json.TypeDuration.Codec
	16, // 42: json.TypeTimestamp.codec:type_name -> json.TypeTimestamp.Codec
	43, // 43: json.TypeTimestamp.layout:type_name -> json.TypeTimestamp.Layout
	44, // 44: json.message:extendee -> google.protobuf.MessageOptions
	45, // 45: json.field:extendee -> google.protobuf.FieldOptions
	46, // 46: json.oneof:extendee -> google.protobuf.OneofOptions
	17, // 47: json.message:type_name -> json.MessageOptions
	19, // 48: json.field:type_name -> json.FieldOptions
	18, // 49: json.oneof:type_name -> json.OneofOptions
	50, // [50:50] is the sub-list for method output_type
	50, // [50:50] is the sub-list for method input_type
	47, // [47:50] is the sub-list for extension type_name
	44, // [44:47] is the sub-list for extension extendee
...
func file_json_proto_init() {
	...
	file_json_proto_msgTypes[3].OneofWrappers = []interface{}{
		(*TypeFormat_Int32)(nil),
		(*TypeFormat_Int64)(nil),
		(*TypeFormat_Sint32)(nil),
		(*TypeFormat_Sint64)(nil),
		(*TypeFormat_Sfixed32)(nil),
		(*TypeFormat_Sfixed64)(nil),
		(*TypeFormat_Uint32)(nil),
		(*TypeFormat_Uint64)(nil),
		(*TypeFormat_Fixed32)(nil),
		(*TypeFormat_Fixed64)(nil),
		(*TypeFormat_Float)(nil),
		(*TypeFormat_Double)(nil),
		(*TypeFormat_Bool)(nil),
		(*TypeFormat_Enum)(nil),
		(*TypeFormat_String_)(nil),
		(*TypeFormat_Bytes)(nil),
		(*TypeFormat_Message)(nil),
		(*TypeFormat_Any)(nil),
		(*TypeFormat_Duration)(nil),
		(*TypeFormat_Timestamp)(nil),
		(*TypeFormat_Repeated)(nil),
		(*TypeFormat_Map)(nil),
	}
	type x struct{}
